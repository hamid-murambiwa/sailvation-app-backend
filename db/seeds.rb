...
cruise = Cruise.create!(name: 'Odyssey', description: "Royal Caribbean's latest ship", image: 'https://user-images.githubusercontent.com/71644515/173540539-dfbd93b6-c3dc-479b-8dfb-55d8b40af1e2.png', user_id: user1.id)
cruise1 = Cruise.create!(name: 'Apex', description: "Celebrity Cruise", image: 'https://user-images.githubusercontent.com/71644515/173545194-57bbce86-78dd-443b-9ddb-f509bd0c99a9.png', user_id: user1.id)
cruise2 = Cruise.create!(name: 'Virtuosa', description: "Mediterranean cruise company ship", image: 'https://user-images.githubusercontent.com/71644515/173552946-742a7387-2980-4589-9c3a-de008c20d2f7.png', user_id: user1.id)
