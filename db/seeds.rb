...
cruise5 = Cruise.create!(name: 'Disney', description: "Disney Fantasy", image: 'https://user-images.githubusercontent.com/71644515/173715995-bc3bb754-d485-4f0c-9013-3cdcaafcab95.png', user_id: user1.id)
cruise6 = Cruise.create!(name: 'Odyssey', description: "Royal Caribbean's latest ship", image: 'https://user-images.githubusercontent.com/71644515/173715688-d3b6fbe8-0f59-4e1b-b9d2-dd9c30a61d1b.png', user_id: user1.id)
